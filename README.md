This is my Kaggle competition for my college, where we need to predict purchase value from multi-session digital behavior using ML.

I have performed EDA and created some charts to analyse the data
